<template>
  <div v-if="searchResults">
    <div v-if="searchResults.orders.data.length > 0">
      ...
      <SearchCard :order="searchResults.orders.data" />
...
import SearchCard from '@/components/Kurye/SearchCard.vue';
import Pagination from '@/components/Kurye/Pagination.vue';
...
onMounted(async () => {
  ...
  if (searchQuery) {
    ...
    const response = await apiClient.get(`/courier/search`, { params: { q: searchQuery } });
