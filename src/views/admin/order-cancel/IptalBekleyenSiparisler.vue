<template>
  <div v-if="allOrders?.data?.length > 0">
    <PageTitle text="İptal Bekleyen Siparişler" />
  ...
  <div v-else>
    <div class="mt-10 max-w-7xl h-96 p-4 mx-auto sm:px-6 lg:px-8 bg-blue-50 flex items-center justify-center">
      <p class="text-center text-2xl text-gray-500 ">İptal Bekleyen Bir Sipariş Bulunmamaktadır.</p>
    </div>
  </div>
...
onMounted(() => {
  ...
  store.fetchRejectedStatusOrders('P');
})
</script>
