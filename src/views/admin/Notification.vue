    ...
    <router-link @click="store.markNotificationAsRead(notification.id)"
      ...
      <div class="flex w-full relative">
        <div class="w-16 text-center p-2 mt-2"
          :class="{ 'bg-gray-500': notification.is_read === '1', 'bg-red-500': notification.is_read === '0' }">
        ...
        <div class="bg-white border-r-4 w-full p-4 mb-2"
          :class="{ 'border-gray-500': notification.is_read === '1', 'border-red-500': notification.is_read === '0' }">
          <div>
