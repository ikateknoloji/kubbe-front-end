<template>
  <div>
    <div class="container">
      <div class="grid grid-cols-12 gap-6 2xl:gap-0 mb-12 items-center aos-init aos-animate" data-aos="fade-up">
        <div class="col-span-12 lg:col-span-6 xl:col-span-6">
          <div class="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
            <span class="text-orange text-xl">Servislerimiz</span>
            <h3
              ...
              Kullanıcı Rollerine Göre Servislerimiz
            </h3>
          </div>
        ...
        <div class="col-span-12 lg:col-span-6 xl:col-span-6">
          <p class="paragraph">
            Kullanıcı rollerinize göre hangi servisleri kullanabileceğiniz yada yönetebileceğiniz servislerleri içeriyor
            olacaktır.
          </p>
        </div>
      </div>
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 xl:col-span-8">
          <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            ...
            <router-link to="/dashboard/admin" class="hover:scale-105"
              :class="{ 'disabled-link': !hasAccess('admin') }">
              <div
                class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
                ...
                <h4>
                  <div
                    ...
                    Admin Sipariş <br> Yönetim Paneli
            ...
            <!-- service Item -->
            <router-link to="/dashboard/musteri" class="hover:scale-105"
              :class="{ 'disabled-link': !hasAccess('musteri') }">
              <div
                class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
                ...
                <h4>
                  <div
                    class="flex flex-wrap items-end justify-between font-bold text-xl font-Syne text-black-800 group-hover:text-orange transition-all">
                    Müşteri Sipariş <br> Yönetim Paneli
            ...
            <!-- service Item -->
            <router-link to="/dashboard/uretici" class="hover:scale-105"
              :class="{ 'disabled-link': !hasAccess('uretici') }">
              <div
                class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
                ...
                <h4>
                  <a href="projects.html"
                    class="flex flex-wrap items-end justify-between font-bold text-xl font-Syne text-black-800 group-hover:text-orange transition-all">
                    Üretici Sipariş <br> Yönetim Paneli
            ...
            <!-- service Item -->
            <router-link to="/dashboard/tasarimci" class="hover:scale-105"
              :class="{ 'disabled-link': !hasAccess('tasarimci') }">
              <div
                class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
                data-aos="fade-up" data-aos-delay="500">
                <!-- Icon -->
            ...
            <!-- service Item -->
            <router-link to="/dashboard/kurye" class="hover:scale-105"
              :class="{ 'disabled-link': !hasAccess('kurye') }">
              <div
                class="px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
                data-aos="fade-up" data-aos-delay="700">
                <!-- Icon -->
            ...
            <div
              class="disabled-link px-6 py-7 bg-black-500 rounded-lg transition-all hover:shadow-2xl hover:bg-white group aos-init aos-animate"
              data-aos="fade-up" data-aos-delay="900">
              <!-- Icon -->
              <div
                class="w-12 h-12 bg-white rounded-full shadow flex flex-wrap items-center justify-center transition-all group-hover:bg-black-500 mb-8">
