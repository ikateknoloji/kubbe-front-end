  ...
  <div class="relative max-w-7xl mx-auto md:flex items-center justify-center">
    <div>
      <div class="container pt-32">
        <div class="grid grid-cols-12 gap-6 2xl:gap-0 mb-12 items-center aos-init aos-animate px-4" data-aos="fade-up">
          ...
          <div class="col-span-12 lg:col-span-6 xl:col-span-6">
            <p class="paragraph">
              Kullanıcı rollerinize göre hangi servisleri kullanabileceğiniz yada yönetebileceğiniz servislerleri
              içeriyor
              olacaktır.
            </p>
          </div>
