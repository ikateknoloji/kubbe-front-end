<template>
  <form @submit.prevent="onSearchSubmit">
    <div
      class="relative hidden ltr:ml-3 rtl:mr-3 lg:block group-data-[layout=horizontal]:hidden group-data-[layout=horizontal]:lg:block m mb-5">
      <input type="text"
...
const onSearchSubmit = () => {
  ...
  router.push({ name: 'desinger-search-results', query: { q: searchQuery.value } }).then(() => {
